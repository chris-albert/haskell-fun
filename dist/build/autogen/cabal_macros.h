...
/* package haskal-fun-1.0 */
#define VERSION_haskal_fun "1.0"
#define MIN_VERSION_haskal_fun(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "haskal-fun-1.0"

#define CURRENT_PACKAGE_KEY "haskal-fun-1.0"
